...
export const getDetailsUser = async (id, access_token) => {
    const res = await axiosJWT.get(`http://localhost:4000/api/user/get-details/${id}`, {
        headers: {
...
export const deleteUser = async (id, access_token, data) => {
    const res = await axiosJWT.delete(`http://localhost:4000/api/user/delete-user/${id}`, data, {
        headers: {
            token: `Bearer ${access_token}`,
        }
    },)
...
export const getAllUser = async (access_token) => {
    const res = await axiosJWT.get(`http://localhost:4000/api/user/getAll`, {
        headers: {
            token: `Bearer ${access_token}`,
        }
    },)
...
export const deleteManyUser = async (data, access_token) => {
    const res = await axiosJWT.post(`http://localhost:4000/api/user/delete-many`, data, {
        headers: {
            token: `Bearer ${access_token}`,
        }
    })
